...
#p_DATASET_DIR='/media/ensanna/Disco Dati 2/PHYSIONET_DATASET/ch_2018'
# -----------------------------------------------------------------------------
...
def import_arousals(file_name):
    ...
    #arousals = arousals[200000:210000]
    return arousals

def import_signals(file_name):
    return np.transpose(scipy.io.loadmat(file_name)['val'])#[200000:210000]
